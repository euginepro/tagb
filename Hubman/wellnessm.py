...
import socket
from modules.eurofutbol.proxies import ProxyManager
from modules.wellnessm.links import WellnessmLinkManager
...
print("Program Start")
set_site_links_manager(WellnessmLinkManager())
set_ctr(0)
loop()
